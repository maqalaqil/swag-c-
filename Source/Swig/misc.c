...
char *alaqil_copy_string(const char *s) {
  char *c = 0;
  if (s) {
...
/* -----------------------------------------------------------------------------
 * alaqil_set_fakeversion()
 *
 * Version string override
 * ----------------------------------------------------------------------------- */

void alaqil_set_fakeversion(const char *version) {
  fake_version = alaqil_copy_string(version);
}
...
const char *alaqil_package_version(void) {
 ...
 * alaqil_banner()
 *
 * Emits the alaqil identifying banner for the C/C++ wrapper file.
 * ----------------------------------------------------------------------------- */

void alaqil_banner(File *f) {
  Printf(f, "/* ----------------------------------------------------------------------------\n\
 * This file was automatically generated by alaqil (http://www.alaqil.org).\n\
 * Version %s\n\
 *\n\
 * This file is not intended to be easily readable and contains a number of\n\
 * coding conventions designed to improve portability and efficiency. Do not make\n\
 * changes to this file unless you know what you are doing--modify the alaqil\n\
...
/* -----------------------------------------------------------------------------
 * alaqil_banner_target_lang()
 *
 * Emits a alaqil identifying banner in the target language
 * ----------------------------------------------------------------------------- */

void alaqil_banner_target_lang(File *f, const_String_or_char_ptr commentchar) {
  Printf(f, "%s This file was automatically generated by alaqil (http://www.alaqil.org).\n", commentchar);
  Printf(f, "%s Version %s\n", commentchar, alaqil_package_version());
  Printf(f, "%s\n", commentchar);
  Printf(f, "%s Do not make changes to this file unless you know what you are doing--modify\n", commentchar);
  Printf(f, "%s the alaqil interface file instead.\n", commentchar);
}

/* -----------------------------------------------------------------------------
 * alaqil_strip_c_comments()
 *
 * Return a new string with C comments stripped from the input string. NULL is
 * returned if there aren't any comments.
 * ----------------------------------------------------------------------------- */

String *alaqil_strip_c_comments(const String *s) {
  const char *c = Char(s);
  ...
  if (comment_begin && comment_end) {
    ...
    do {
      stripmore = alaqil_strip_c_comments(stripped);
      if (stripmore) {
        Delete(stripped);
        stripped = stripmore;
      }
...
static int is_directory(String *directory) {
  ...
  if (dir[last] == alaqil_FILE_DELIMITER[0]) {
    /* remove trailing slash - can cause S_ISDIR to fail on Windows, at least */
    dir[last] = 0;
    statres = stat(dir, &st);
    dir[last] = alaqil_FILE_DELIMITER[0];
  } else {
    statres = stat(dir, &st);
  }
...
String *alaqil_new_subdirectory(String *basedirectory, String *subdirectory) {
  String *error = 0;
  ...
  if (current_directory || is_directory(basedirectory)) {
    ...
    List *subdirs = Split(subdirectory, alaqil_FILE_DELIMITER[0], INT_MAX);
	...
	break;
      ...
      Printf(dir, alaqil_FILE_DELIMITER);
    }
  } else {
...
void alaqil_filename_correct(String *filename) {
  int network_path = 0;
  if (Len(filename) >= 2) {
...
#if defined(_WIN32) || defined(MACalaqil)
  /* accept Unix path separator on non-Unix systems */
  Replaceall(filename, "/", alaqil_FILE_DELIMITER);
#endif
  ...
  while (Replaceall(filename, alaqil_FILE_DELIMITER alaqil_FILE_DELIMITER, alaqil_FILE_DELIMITER)) {
  }
  /* Network paths can start with a double slash on Windows - unremove the duplicate slash we just removed */
  if (network_path)
    Insert(filename, 0, alaqil_FILE_DELIMITER);
}

/* -----------------------------------------------------------------------------
 * alaqil_filename_escape()
 *
 * Escapes backslashes in filename - for Windows
 * ----------------------------------------------------------------------------- */

String *alaqil_filename_escape(String *filename) {
  String *adjusted_filename = Copy(filename);
  alaqil_filename_correct(adjusted_filename);
...
/* -----------------------------------------------------------------------------
 * alaqil_filename_unescape()
 *
 * Remove double backslash escaping in filename - for Windows
 * ----------------------------------------------------------------------------- */

void alaqil_filename_unescape(String *filename) {
  (void)filename;
#if defined(_WIN32)
  Replaceall(filename, "\\\\", "\\");
#endif
...
/* -----------------------------------------------------------------------------
 * alaqil_string_hexescape()
 *
 * Takes a string object and produces a string with escape codes added to it.
 * Hex escaping is used.
 * ----------------------------------------------------------------------------- */

String *alaqil_string_hexescape(String *s) {
  String *ns;
  int c;
  ns = NewStringEmpty();
...
String *alaqil_string_upper(String *s) {
  String *ns;
  int c;
  ns = NewStringEmpty();
...
String *alaqil_string_lower(String *s) {
  String *ns;
  int c;
  ns = NewStringEmpty();
...
String *alaqil_string_title(String *s) {
  String *ns;
  int first = 1;
  int c;
  ns = NewStringEmpty();
...
String *alaqil_string_ccase(String *s) {
  String *ns;
  int first = 1;
  int c;
  ns = NewStringEmpty();
...
String *alaqil_string_lccase(String *s) {
  String *ns;
  int first = 1;
...
String *alaqil_string_ucase(String *s) {
  String *ns;
  int c;
  int lastC = 0;
  int nextC = 0;
...
String *alaqil_string_first_upper(String *s) {
...
String *alaqil_string_first_lower(String *s) {
  String *ns = NewStringEmpty();
  char *cs = Char(s);
  if (cs && cs[0] != 0) {
...
String *alaqil_string_schemify(String *s) {
...
String *alaqil_string_mangle(const String *s) {
#if 0
  ...
  char *pc, *cb;
  String *b = Copy(s);
  if (alaqilType_istemplate(b)) {
    String *st = alaqil_symbol_template_deftype(b, 0);
    String *sq = alaqil_symbol_type_qualify(st, 0);
    String *t = alaqilType_namestr(sq);
    Delete(st);
    Delete(sq);
    Delete(b);
    b = t;
...
String *alaqil_string_emangle(String *s) {
  return alaqil_string_mangle(s);
}


/* -----------------------------------------------------------------------------
 * alaqil_scopename_split()
 *
...
void alaqil_scopename_split(const String *s, String **rprefix, String **rlast) {
  char *tmp = Char(s);
  char *c = tmp;
  char *cc = c;
  char *co = 0;
...
/* -----------------------------------------------------------------------------
 * alaqil_scopename_prefix()
 *
 * Take a qualified name like "A::B::C" and return the scope name.
 * In this case, "A::B".   Returns NULL if there is no base.
 * ----------------------------------------------------------------------------- */

String *alaqil_scopename_prefix(const String *s) {
  char *tmp = Char(s);
  char *c = tmp;
  char *cc = c;
  char *co = 0;
...
/* -----------------------------------------------------------------------------
 * alaqil_scopename_last()
 *
 * Take a qualified name like "A::B::C" and returns the last.  In this
 * case, "C". 
 * ----------------------------------------------------------------------------- */

String *alaqil_scopename_last(const String *s) {
  char *tmp = Char(s);
  char *c = tmp;
  char *cc = c;
  char *co = 0;
...
List *alaqil_scopename_tolist(const String *s) {
  List *scopes = NewList();
  ...
  while (name) {
    String *last = 0;
    String *prefix = 0;
    alaqil_scopename_split(name, &prefix, &last);
...
int alaqil_scopename_check(const String *s) {
  char *c = Char(s);
...
String *alaqil_string_command(String *s) {
  ...
  if (Len(s)) {
	...
	Append(res, buffer);
      ...
      alaqil_error("alaqil", Getline(s), "Command encoder fails attempting '%s'.\n", s);
      exit(1);
    }
  }
#endif
...
String *alaqil_string_strip(String *s) {
  String *ns;
  if (!Len(s)) {
    ns = NewString(s);
  } else {
...
String *alaqil_string_rstrip(String *s) {
  String *ns;
  int len = Len(s);
  if (!len) {
    ns = NewString(s);
...
/* -----------------------------------------------------------------------------
 * alaqil_offset_string()
 *
 * Insert number tabs before each new line in s
 * ----------------------------------------------------------------------------- */

void alaqil_offset_string(String *s, int number) {
...
err_out:
  alaqil_error("alaqil", Getline(s), "Invalid regex substitution: '%s'.\n", s);
  exit(1);
}
...
String *replace_captures(int num_captures, const char *input, String *subst, int captures[], String *pattern, String *s)
{
  ...
  while (*p) {
	...
	alaqil_error("alaqil", Getline(s), "PCRE capture replacement failed while matching \"%s\" using \"%s\" - request for group %d is greater than the number of captures %d.\n",
	...
	case 'E':
	  ...
	  break;
	default:
	  alaqil_error("alaqil", Getline(s), "Unrecognized escape character '%c' in the replacement string \"%s\".\n",
	      *p, Char(subst));
	}
	p++;
    }
 ...
 * ----------------------------------------------------------------------------- */
String *alaqil_string_regex(String *s) {
  ...
  if (split_regex_pattern_subst(s, &pattern, &subst, &input)) {
    ...
    if (!compiled_pat) {
      alaqil_error("alaqil", Getline(s), "PCRE compilation failed: '%s' in '%s':%i.\n",
    ...
    if (rc >= 0) {
      ...
      alaqil_error("alaqil", Getline(s), "PCRE execution failed: error %d while matching \"%s\" using \"%s\".\n",
...
String *alaqil_pcre_version(void) {
...
String *alaqil_string_regex(String *s) {
  alaqil_error("alaqil", Getline(s), "PCRE regex support not enabled in this alaqil build.\n");
  exit(1);
}
...
void alaqil_init() {
  ...
  DohEncoding("escape", alaqil_string_escape);
  DohEncoding("hexescape", alaqil_string_hexescape);
  DohEncoding("upper", alaqil_string_upper);
  DohEncoding("lower", alaqil_string_lower);
  DohEncoding("title", alaqil_string_title);
  DohEncoding("ctitle", alaqil_string_ccase);
  DohEncoding("lctitle", alaqil_string_lccase);
  DohEncoding("utitle", alaqil_string_ucase);
  DohEncoding("typecode", alaqil_string_typecode);
  DohEncoding("mangle", alaqil_string_emangle);
  DohEncoding("command", alaqil_string_command);
  DohEncoding("schemify", alaqil_string_schemify);
  DohEncoding("strip", alaqil_string_strip);
  DohEncoding("rstrip", alaqil_string_rstrip);
  DohEncoding("regex", alaqil_string_regex);

  /* aliases for the case encoders */
  DohEncoding("uppercase", alaqil_string_upper);
  DohEncoding("lowercase", alaqil_string_lower);
  DohEncoding("camelcase", alaqil_string_ccase);
  DohEncoding("lowercamelcase", alaqil_string_lccase);
  DohEncoding("undercase", alaqil_string_ucase);
  DohEncoding("firstuppercase", alaqil_string_first_upper);
  DohEncoding("firstlowercase", alaqil_string_first_lower);
  ...
  alaqilType_typesystem_init();

  /* Initialize template system */
  alaqilType_template_init();
}
