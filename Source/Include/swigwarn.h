 ...
 * alaqilwarn.h
 *
 * alaqil warning message numbers
 * This file serves as the main registry of warning message numbers.  Some of these
 * numbers are used internally in the C/C++ source code of alaqil.   However, some
 * of the numbers are used in alaqil configuration files (alaqil.swg and others).
 *
 * The numbers are roughly organized into a few different classes by functionality.
 *
 * Even though symbolic constants are used in the alaqil source, this is
 * not always the case in alaqil interface files.  Do not change the
 * numbers in this file.
 *
 * This file is used as the input for generating Lib/alaqilwarn.swg.
 * ----------------------------------------------------------------------------- */

#ifndef alaqilWARN_H_
#define alaqilWARN_H_
...
#define WARN_TYPEMAP_alaqilTYPE         452
#define WARN_TYPEMAP_APPLY_UNDEF      453
#define WARN_TYPEMAP_alaqilTYPELEAK     454
