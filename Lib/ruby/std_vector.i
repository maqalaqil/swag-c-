...
%define %alaqil_vector_methods(Type...) 
  %alaqil_sequence_methods(Type)
  %alaqil_sequence_front_inserters(Type);
%enddef

%define %alaqil_vector_methods_val(Type...) 
  %alaqil_sequence_methods_val(Type);
  %alaqil_sequence_front_inserters(Type);
%enddef
