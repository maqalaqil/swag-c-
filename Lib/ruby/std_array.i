...
%define %alaqil_array_methods(Type...)
  %alaqil_sequence_methods_non_resizable(Type)
%enddef

%define %alaqil_array_methods_val(Type...)
  %alaqil_sequence_methods_non_resizable_val(Type);
%enddef
