...
%{
   ...
   // vectors of 64 bit unsigned int
    ...
    template <typename T>
      ...
      static SEXP from (std::vector< T > *val, int owner = 0) {
        return alaqil_R_NewPointerObj(val, type_info< std::vector< T >  >(), owner);
      }
    };
    /////////////////////////////////////////////////
    template <>
  ...
  struct traits_asptr < std::vector<T> > {
    static int asptr(SEXP obj, std::vector<T> **val) {
      std::vector<T> *p;
      int res = alaqil_R_ConvertPtr(obj, (void**)&p, type_info< std::vector<T> >(), 0);
      if (alaqil_IsOK(res)) {
        if (val) *val = p;
      }
      return res;
  ...
  template <typename T>
    ...
    static SEXP from (std::vector < std::vector< T > > *val, int owner = 0) {
      return alaqil_R_NewPointerObj(val, type_info< std::vector < std::vector< T > > >(), owner);
    }
  };
  ...
  template <typename T>
    ...
    static int asptr(SEXP obj, std::vector< std::vector<T> > **val) {
      ...
      int res = alaqil_R_ConvertPtr(obj, (void**)&p, type_info< std::vector< std::vector<T> > > (), 0);
      if (alaqil_IsOK(res)) {
        if (val) *val = p;
      }
      return res;
...
%typemap_traits_ptr(alaqil_TYPECHECK_VECTOR, std::vector<double>)
...
%typemap_traits_ptr(alaqil_TYPECHECK_VECTOR, std::vector<float>)
...
%typemap_traits_ptr(alaqil_TYPECHECK_VECTOR, std::vector<bool>);
...
%typemap_traits_ptr(alaqil_TYPECHECK_VECTOR, std::vector<int>);
...
// signed
%typemap_traits_ptr(alaqil_TYPECHECK_VECTOR, std::vector<signed char>);
%traits_type_name(std::vector<signed char>);

%typemap_traits_ptr(alaqil_TYPECHECK_VECTOR, std::vector<signed short>);
%traits_type_name(std::vector<signed short>);

#if defined(alaqilWORDSIZE64)
%typemap_traits_ptr(alaqil_TYPECHECK_VECTOR, std::vector<long int>);
%traits_type_name(std::vector<long int>);
#else
%typemap_traits_ptr(alaqil_TYPECHECK_VECTOR, std::vector<long long int>);
%traits_type_name(std::vector<long long int>);
#endif

// unsigned
%typemap_traits_ptr(alaqil_TYPECHECK_VECTOR, std::vector<unsigned char>);
%traits_type_name(std::vector<unsigned char>);

%typemap_traits_ptr(alaqil_TYPECHECK_VECTOR, std::vector<unsigned short>);
%traits_type_name(std::vector<unsigned short>);

%typemap_traits_ptr(alaqil_TYPECHECK_VECTOR, std::vector<unsigned int>);
%traits_type_name(std::vector<unsigned int>);

#if defined(alaqilWORDSIZE64)
%typemap_traits_ptr(alaqil_TYPECHECK_VECTOR, std::vector<unsigned long int>);
%traits_type_name(std::vector<unsigned long int>);
#else
%typemap_traits_ptr(alaqil_TYPECHECK_VECTOR, std::vector<unsigned long long int>);
...
%typemap_traits_ptr(alaqil_TYPECHECK_VECTOR, std::vector<std::vector<int> >);
...
%typemap_traits_ptr(alaqil_TYPECHECK_VECTOR, std::vector<std::vector<unsigned int> >);
...
%typemap_traits_ptr(alaqil_TYPECHECK_VECTOR, std::vector<std::vector<float> >);
...
%typemap_traits_ptr(alaqil_TYPECHECK_VECTOR, std::vector<std::vector<double> >);
...
%typemap_traits_ptr(alaqil_TYPECHECK_VECTOR, std::vector<std::vector<bool> >);
