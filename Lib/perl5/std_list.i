...
namespace std {
    ...
    template<class T> class list {
        ...
        %typecheck(alaqil_TYPECHECK_LIST) list<T> {
            {
                /* wrapped list? */
                std::list< T >* v;
                if (alaqil_ConvertPtr($input,(void **) &v, 
        ...
        %typecheck(alaqil_TYPECHECK_LIST) const list<T>&,
                                          const list<T>* {
            {
                /* wrapped list? */
                std::list< T >* v;
    ...
    specialize_std_list(float,SvNIOK,alaqilSvToNumber,sv_setnv);
    specialize_std_list(double,SvNIOK,alaqilSvToNumber,sv_setnv);
    specialize_std_list(std::string,SvPOK,SvPVX,alaqilSvFromString);
