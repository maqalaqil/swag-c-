 ...
 * std_except.i
 *
 * alaqil library file with typemaps to handle and throw STD exceptions in a
...
#if defined(alaqilJAVA) || defined(alaqilCSHARP) || defined(alaqilGUILE) || defined(alaqilUTL) || defined(alaqilD) || defined(alaqilOCAML)
