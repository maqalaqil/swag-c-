...
namespace std {
  ...
  public:
    ...
    %fragment(alaqil_Traits_frag(std::unordered_multiset< _Key, _Hash, _Compare, _Alloc >), "header",
    ...
    %typemap_traits_ptr(alaqil_TYPECHECK_MULTISET, std::unordered_multiset< _Key, _Hash, _Compare, _Alloc >);

#ifdef %alaqil_unordered_multiset_methods
    // Add alaqil/language extra methods
    %alaqil_unordered_multiset_methods(std::unordered_multiset< _Key, _Hash, _Compare, _Alloc >);
#endif
