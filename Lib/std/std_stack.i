...
namespace std {
  ...
  public:
    ...
    %fragment(alaqil_Traits_frag(std::stack< _Tp, _Sequence >), "header",
    ...
    %typemap_traits_ptr(alaqil_TYPECHECK_STACK, std::stack< _Tp, _Sequence >);
  
#ifdef %alaqil_stack_methods
    // Add alaqil/language extra methods
    %alaqil_stack_methods(std::stack< _Tp, _Sequence >);
#endif
...
#ifdef %alaqil_stack_methods_val
    // Add alaqil/language extra methods
    %alaqil_stack_methods_val(std::stack< _Tp*, _Sequence >);
#endif
