...
namespace std {
  ...
  public:
    ...
    %fragment(alaqil_Traits_frag(std::deque< _Tp, _Alloc >), "header",
    ...
    %typemap_traits_ptr(alaqil_TYPECHECK_DEQUE, std::deque< _Tp, _Alloc >);
  
#ifdef %alaqil_deque_methods
    // Add alaqil/language extra methods
    %alaqil_deque_methods(std::deque< _Tp, _Alloc >);
#endif
...
#ifdef %alaqil_deque_methods_val
    // Add alaqil/language extra methods
    %alaqil_deque_methods_val(std::deque< _Tp*, _Alloc >);
#endif
