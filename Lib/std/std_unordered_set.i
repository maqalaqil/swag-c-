...
namespace std {
  ...
  public:
    ...
    %fragment(alaqil_Traits_frag(std::unordered_set< _Key, _Hash, _Compare, _Alloc >), "header",
    ...
    %typemap_traits_ptr(alaqil_TYPECHECK_SET, std::unordered_set< _Key, _Hash, _Compare, _Alloc >);

#ifdef %alaqil_unordered_set_methods
    // Add alaqil/language extra methods
    %alaqil_unordered_set_methods(std::unordered_set< _Key, _Hash, _Compare, _Alloc >);
#endif
