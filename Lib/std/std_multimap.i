...
namespace std {
  ...
  public:
    ...
    %fragment(alaqil_Traits_frag(std::multimap< _Key, _Tp, _Compare, _Alloc >), "header",
    ...
    %typemap_traits_ptr(alaqil_TYPECHECK_MULTIMAP, std::multimap< _Key, _Tp, _Compare, _Alloc >);
  
    multimap(const _Compare& other);

#ifdef %alaqil_multimap_methods
    // Add alaqil/language extra methods
    %alaqil_multimap_methods(std::multimap< _Key, _Tp, _Compare, _Alloc >);
#endif
