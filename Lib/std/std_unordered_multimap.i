...
namespace std {
  ...
  public:
    ...
    %fragment(alaqil_Traits_frag(std::unordered_multimap< _Key, _Tp, _Hash, _Pred, _Alloc >), "header",
    ...
    %typemap_traits_ptr(alaqil_TYPECHECK_MULTIMAP, std::unordered_multimap< _Key, _Tp, _Hash, _Pred, _Alloc >);
  
#ifdef %alaqil_unordered_multimap_methods
    // Add alaqil/language extra methods
    %alaqil_unordered_multimap_methods(std::unordered_multimap< _Key, _Tp, _Hash, _Pred, _Alloc >);
#endif
