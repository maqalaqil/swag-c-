...
%typemap(in, checkfn="alaqil_lua_isnilstring", fragment="alaqil_lua_isnilstring") wchar_t *
%{
$1 = str2wstr(lua_tostring( L, $input ),lua_rawlen( L, $input ));
if ($1==0) {alaqil_Lua_pushferrstring(L,"Error in converting to wchar (arg %d)",$input);goto fail;}
%}
