 ...
 * typemaps.i
 *
 * alaqil typemap library for Tcl8.  This file contains various sorts
 * of typemaps for modifying alaqil's code generation.
 * ----------------------------------------------------------------------------- */

#if !defined(alaqil_USE_OLD_TYPEMAPS)
%include <typemaps/typemaps.swg>
#else

/*
The alaqil typemap library provides a language independent mechanism for
