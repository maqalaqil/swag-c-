...
A startup file may be specified by defining the symbol alaqil_RcFileName
as follows (this should be included in a code-block) :

     #define alaqil_RcFileName    "~/.mywishrc"
%}
#endif
...
/* For Macintosh might also want this */
    ...
    Tcl_SetVar(interp, (char *) "tcl_rcRsrcName",alaqil_RcRsrcName,TCL_GLOBAL_ONLY);
#endif
#endif
    return TCL_OK;
}
