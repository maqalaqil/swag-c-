...
// For Python
%warnfilter(alaqilWARN_TYPE_UNDEFINED_CLASS) Bar; // Base class 'Foo' ignored - unknown module name for base. Either import the appropriate module interface file or specify the name of the module in the %import directive. 

%import "import_nomodule.h"

#if !defined(alaqilJAVA) && !defined(alaqilRUBY) && !defined(alaqilCSHARP) && !defined(alaqilD) && !defined(alaqilPYTHON_BUILTIN)
