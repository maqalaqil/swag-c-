...
/*
alaqil-devel mailing list report problem explained 2014-01-07
A setter for the global variable deleted_bits is generated because there is no template
instantiation for the template and hence alaqil does not find the private assignment operator.
alaqilValueWrapper is probably on by default for templates that are not instantiated for the
same reason.
