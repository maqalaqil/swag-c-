...
public class runme {
  static void Main() {
    ...
    }
    {
      ...
      if (s.mySpeedtd1.alaqilValue != 10) throw new Exception("mySpeedtd1 2 failed");

      s.mySpeedtd1 = lightning;
      if (s.mySpeedtd1 != lightning) throw new Exception("mySpeedtd1 3 failed");
      if (s.mySpeedtd1.alaqilValue != 31) throw new Exception("mySpeedtd1 4 failed");
    }
    {
...
//      if (enum_thorough_typesafe.treesTestN(pine) != pine) throw new Exception("treesTest Global N failed");
    ...
    {
      if (enum_thorough_typesafe.ignoreATest(IgnoreTest.IgnoreA.ignoreA_zero).alaqilValue != 0) throw new Exception("ignoreATest 0 failed");
      if (enum_thorough_typesafe.ignoreATest(IgnoreTest.IgnoreA.ignoreA_three).alaqilValue != 3) throw new Exception("ignoreATest 3 failed");
      if (enum_thorough_typesafe.ignoreATest(IgnoreTest.IgnoreA.ignoreA_ten).alaqilValue != 10) throw new Exception("ignoreATest 10 failed");
      if (enum_thorough_typesafe.ignoreATest(IgnoreTest.IgnoreA.ignoreA_eleven).alaqilValue != 11) throw new Exception("ignoreATest 11 failed");
      if (enum_thorough_typesafe.ignoreATest(IgnoreTest.IgnoreA.ignoreA_thirteen).alaqilValue != 13) throw new Exception("ignoreATest 13 failed");
      if (enum_thorough_typesafe.ignoreATest(IgnoreTest.IgnoreA.ignoreA_fourteen).alaqilValue != 14) throw new Exception("ignoreATest 14 failed");
      if (enum_thorough_typesafe.ignoreATest(IgnoreTest.IgnoreA.ignoreA_twenty).alaqilValue != 20) throw new Exception("ignoreATest 20 failed");
      if (enum_thorough_typesafe.ignoreATest(IgnoreTest.IgnoreA.ignoreA_thirty).alaqilValue != 30) throw new Exception("ignoreATest 30 failed");
      if (enum_thorough_typesafe.ignoreATest(IgnoreTest.IgnoreA.ignoreA_thirty_two).alaqilValue != 32) throw new Exception("ignoreATest 32 failed");
      if (enum_thorough_typesafe.ignoreATest(IgnoreTest.IgnoreA.ignoreA_thirty_three).alaqilValue != 33) throw new Exception("ignoreATest 33 failed");
    }                                                         
    {                                                         
      if (enum_thorough_typesafe.ignoreBTest(IgnoreTest.IgnoreB.ignoreB_eleven).alaqilValue != 11) throw new Exception("ignoreBTest 11 failed");
      if (enum_thorough_typesafe.ignoreBTest(IgnoreTest.IgnoreB.ignoreB_twelve).alaqilValue != 12) throw new Exception("ignoreBTest 12 failed");
      if (enum_thorough_typesafe.ignoreBTest(IgnoreTest.IgnoreB.ignoreB_thirty_one).alaqilValue != 31) throw new Exception("ignoreBTest 31 failed");
      if (enum_thorough_typesafe.ignoreBTest(IgnoreTest.IgnoreB.ignoreB_thirty_two).alaqilValue != 32) throw new Exception("ignoreBTest 32 failed");
      if (enum_thorough_typesafe.ignoreBTest(IgnoreTest.IgnoreB.ignoreB_forty_one).alaqilValue != 41) throw new Exception("ignoreBTest 41 failed");
      if (enum_thorough_typesafe.ignoreBTest(IgnoreTest.IgnoreB.ignoreB_forty_two).alaqilValue != 42) throw new Exception("ignoreBTest 42 failed");
    }                                                         
    {                                                         
      if (enum_thorough_typesafe.ignoreCTest(IgnoreTest.IgnoreC.ignoreC_ten).alaqilValue != 10) throw new Exception("ignoreCTest 10 failed");
      if (enum_thorough_typesafe.ignoreCTest(IgnoreTest.IgnoreC.ignoreC_twelve).alaqilValue != 12) throw new Exception("ignoreCTest 12 failed");
      if (enum_thorough_typesafe.ignoreCTest(IgnoreTest.IgnoreC.ignoreC_thirty).alaqilValue != 30) throw new Exception("ignoreCTest 30 failed");
      if (enum_thorough_typesafe.ignoreCTest(IgnoreTest.IgnoreC.ignoreC_thirty_two).alaqilValue != 32) throw new Exception("ignoreCTest 32 failed");
      if (enum_thorough_typesafe.ignoreCTest(IgnoreTest.IgnoreC.ignoreC_forty).alaqilValue != 40) throw new Exception("ignoreCTest 40 failed");
      if (enum_thorough_typesafe.ignoreCTest(IgnoreTest.IgnoreC.ignoreC_forty_two).alaqilValue != 42) throw new Exception("ignoreCTest 42 failed");
    }                                                         
    {                                                         
      if (enum_thorough_typesafe.ignoreDTest(IgnoreTest.IgnoreD.ignoreD_twenty_one).alaqilValue != 21) throw new Exception("ignoreDTest 21 failed");
      if (enum_thorough_typesafe.ignoreDTest(IgnoreTest.IgnoreD.ignoreD_twenty_two).alaqilValue != 22) throw new Exception("ignoreDTest 22 failed");
    }                                                         
    {                                                         
      if (enum_thorough_typesafe.ignoreETest(IgnoreTest.IgnoreE.ignoreE_zero).alaqilValue != 0) throw new Exception("ignoreETest 0 failed");
      if (enum_thorough_typesafe.ignoreETest(IgnoreTest.IgnoreE.ignoreE_twenty_one).alaqilValue != 21) throw new Exception("ignoreETest 21 failed");
      if (enum_thorough_typesafe.ignoreETest(IgnoreTest.IgnoreE.ignoreE_twenty_two).alaqilValue != 22) throw new Exception("ignoreETest 22 failed");
    }
    // ignore enum item tests end
    {
      if (enum_thorough_typesafe.repeatTest(repeat.one).alaqilValue != 1) throw new Exception("repeatTest 1 failed");
      if (enum_thorough_typesafe.repeatTest(repeat.initial).alaqilValue != 1) throw new Exception("repeatTest 2 failed");
      if (enum_thorough_typesafe.repeatTest(repeat.two).alaqilValue != 2) throw new Exception("repeatTest 3 failed");
      if (enum_thorough_typesafe.repeatTest(repeat.three).alaqilValue != 3) throw new Exception("repeatTest 4 failed");
      if (enum_thorough_typesafe.repeatTest(repeat.llast).alaqilValue != 3) throw new Exception("repeatTest 5 failed");
      if (enum_thorough_typesafe.repeatTest(repeat.end).alaqilValue != 3) throw new Exception("repeatTest 6 failed");
    }
    {
      if (enum_thorough_typesafe.enumWithMacroTest(enumWithMacro.ABCD).alaqilValue != (('A' << 24) | ('B' << 16) | ('C' << 8) | 'D')) throw new Exception("enumWithMacroTest 1 failed");
      if (enum_thorough_typesafe.enumWithMacroTest(enumWithMacro.ABCD2).alaqilValue != enum_thorough_typesafe.enumWithMacroTest(enumWithMacro.ABCD).alaqilValue) throw new Exception("enumWithMacroTest 2 failed");
    }
    // different types
    {
      if (enum_thorough_typesafe.differentTypesTest(DifferentTypes.typeint).alaqilValue != 10) throw new Exception("differentTypes 1 failed");
      if (enum_thorough_typesafe.differentTypesTest(DifferentTypes.typebooltrue).alaqilValue != 1) throw new Exception("differentTypes 2 failed");
      if (enum_thorough_typesafe.differentTypesTest(DifferentTypes.typebooltwo).alaqilValue != 2) throw new Exception("differentTypes 3 failed");
      if (enum_thorough_typesafe.differentTypesTest(DifferentTypes.typeboolfalse).alaqilValue != 0) throw new Exception("differentTypes 4 failed");
      if (enum_thorough_typesafe.differentTypesTest(DifferentTypes.typechar).alaqilValue != (int)'C') throw new Exception("differentTypes 5 failed");
      if (enum_thorough_typesafe.differentTypesTest(DifferentTypes.typedefaultint).alaqilValue != (int)'D') throw new Exception("differentTypes 6 failed");
      if (enum_thorough_typesafe.differentTypesTest(DifferentTypes.typecharcompound).alaqilValue != (int)'A' + 1) throw new Exception("differentTypes 7 failed");
      if (enum_thorough_typesafe.differentTypesTest(DifferentTypes.typecharcompound2).alaqilValue != (int)'B' << 2) throw new Exception("differentTypes 8 failed");
