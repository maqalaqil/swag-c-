...
%warnfilter(alaqilWARN_LANG_OVERLOAD_IGNORED,alaqilWARN_LANG_OVERLOAD_SHADOW) UseA(std::shared_ptr<MyType> mytype);
%warnfilter(alaqilWARN_LANG_OVERLOAD_IGNORED,alaqilWARN_LANG_OVERLOAD_SHADOW) UseB(int, std::shared_ptr<MyType> mytype);
%warnfilter(alaqilWARN_LANG_OVERLOAD_IGNORED,alaqilWARN_LANG_OVERLOAD_SHADOW) UseC(int, std::shared_ptr<MyType> mytype, std::shared_ptr<MyType>);

%warnfilter(alaqilWARN_LANG_OVERLOAD_IGNORED,alaqilWARN_LANG_OVERLOAD_SHADOW) UseX(MyType &mytype);
%warnfilter(alaqilWARN_LANG_OVERLOAD_IGNORED,alaqilWARN_LANG_OVERLOAD_SHADOW) UseY(int, MyType &mytype);
%warnfilter(alaqilWARN_LANG_OVERLOAD_IGNORED,alaqilWARN_LANG_OVERLOAD_SHADOW) UseZ(int, MyType &mytype, std::shared_ptr<MyType>);

%warnfilter(alaqilWARN_LANG_OVERLOAD_IGNORED,alaqilWARN_LANG_OVERLOAD_SHADOW) Combo1;
%warnfilter(alaqilWARN_LANG_OVERLOAD_IGNORED,alaqilWARN_LANG_OVERLOAD_SHADOW) Combo2;
%warnfilter(alaqilWARN_LANG_OVERLOAD_IGNORED,alaqilWARN_LANG_OVERLOAD_SHADOW) Combo3;
%warnfilter(alaqilWARN_LANG_OVERLOAD_IGNORED,alaqilWARN_LANG_OVERLOAD_SHADOW) Combo4;
%warnfilter(alaqilWARN_LANG_OVERLOAD_IGNORED,alaqilWARN_LANG_OVERLOAD_SHADOW) Combo5;
%warnfilter(alaqilWARN_LANG_OVERLOAD_IGNORED,alaqilWARN_LANG_OVERLOAD_SHADOW) Combo6;
%warnfilter(alaqilWARN_LANG_OVERLOAD_IGNORED,alaqilWARN_LANG_OVERLOAD_SHADOW) Combo7;
