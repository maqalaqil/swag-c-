...
private:
  ...
  static void increment() { alaqilExamples::Lock lock(critical_section); total_count++; if (debug_shared) cout << "      ++xxxxx Klass::increment tot: " << total_count << endl;}
  static void decrement() { alaqilExamples::Lock lock(critical_section); total_count--; if (debug_shared) cout << "      --xxxxx Klass::decrement tot: " << total_count << endl;}
  static int total_count;
  std::string value;
  int array[1024];
};
alaqilExamples::CriticalSection Space::Klass::critical_section;
...
alaqilBoost::shared_ptr<KlassDerived> derivedsmartptrtest(alaqilBoost::shared_ptr<KlassDerived> kd) {
  if (kd)
    kd->append(" derivedsmartptrtest");
  return kd;
}
alaqilBoost::shared_ptr<KlassDerived>* derivedsmartptrpointertest(alaqilBoost::shared_ptr<KlassDerived>* kd) {
  if (kd && *kd)
    (*kd)->append(" derivedsmartptrpointertest");
  return kd;
}
alaqilBoost::shared_ptr<KlassDerived>* derivedsmartptrreftest(alaqilBoost::shared_ptr<KlassDerived>* kd) {
  if (kd && *kd)
    (*kd)->append(" derivedsmartptrreftest");
  return kd;
}
alaqilBoost::shared_ptr<KlassDerived>*& derivedsmartptrpointerreftest(alaqilBoost::shared_ptr<KlassDerived>*& kd) {
  if (kd && *kd)
...
std::string test3rdupcast( alaqilBoost::shared_ptr< Klass > k) {
  return k->getValue();
}



alaqilBoost::shared_ptr<Klass> factorycreate() {
  return alaqilBoost::shared_ptr<Klass>(new Klass("factorycreate"));
}
// smart pointer
alaqilBoost::shared_ptr<Klass> smartpointertest(alaqilBoost::shared_ptr<Klass> k) {
  if (k)
    k->append(" smartpointertest");
  return alaqilBoost::shared_ptr<Klass>(k);
}
alaqilBoost::shared_ptr<Klass>* smartpointerpointertest(alaqilBoost::shared_ptr<Klass>* k) {
  if (k && *k)
    (*k)->append(" smartpointerpointertest");
  return k;
}
alaqilBoost::shared_ptr<Klass>& smartpointerreftest(alaqilBoost::shared_ptr<Klass>& k) {
  if (k)
    k->append(" smartpointerreftest");
  return k;
}
alaqilBoost::shared_ptr<Klass>*& smartpointerpointerreftest(alaqilBoost::shared_ptr<Klass>*& k) {
  if (k && *k)
    (*k)->append(" smartpointerpointerreftest");
  return k;
}
// const
alaqilBoost::shared_ptr<const Klass> constsmartpointertest(alaqilBoost::shared_ptr<const Klass> k) {
  return alaqilBoost::shared_ptr<const Klass>(k);
}
alaqilBoost::shared_ptr<const Klass>* constsmartpointerpointertest(alaqilBoost::shared_ptr<const Klass>* k) {
  return k;
}
alaqilBoost::shared_ptr<const Klass>& constsmartpointerreftest(alaqilBoost::shared_ptr<const Klass>& k) {
  return k;
}
// plain pointer
...
// null
std::string nullsmartpointerpointertest(alaqilBoost::shared_ptr<Klass>* k) {
  if (k && *k)
    return "not null";
  else if (!k)
...
alaqilBoost::shared_ptr<Klass>* smartpointerpointerownertest() {
  return new alaqilBoost::shared_ptr<Klass>(new Klass("smartpointerpointerownertest"));
}
...
long use_count(const alaqilBoost::shared_ptr<Klass3rdDerived>& sptr) {
  return sptr.use_count();
}
long use_count(const alaqilBoost::shared_ptr<Klass2ndDerived>& sptr) {
  return sptr.use_count();
}
long use_count(const alaqilBoost::shared_ptr<KlassDerived>& sptr) {
  return sptr.use_count();
}
long use_count(const alaqilBoost::shared_ptr<Klass>& sptr) {
  return sptr.use_count();
}
const alaqilBoost::shared_ptr<Klass>& ref_1() {
  static alaqilBoost::shared_ptr<Klass> sptr;
  return sptr;
}
...
std::string overload_smartbyval(alaqilBoost::shared_ptr<Klass> k) { return "smartbyval"; }

std::string overload_smartbyref(int i) { return "int"; }
std::string overload_smartbyref(alaqilBoost::shared_ptr<Klass> &k) { return "smartbyref"; }

std::string overload_smartbyptr(int i) { return "int"; }
std::string overload_smartbyptr(alaqilBoost::shared_ptr<Klass> *k) { return "smartbyptr"; }

std::string overload_smartbyptrref(int i) { return "int"; }
std::string overload_smartbyptrref(alaqilBoost::shared_ptr<Klass> *&k) { return "smartbyptrref"; }
...
struct MemberVariables {
  ...
  alaqilBoost::shared_ptr<Space::Klass> SmartMemberValue;
  alaqilBoost::shared_ptr<Space::Klass> * SmartMemberPointer;
  alaqilBoost::shared_ptr<Space::Klass> & SmartMemberReference;
...
// Global variables
alaqilBoost::shared_ptr<Space::Klass> GlobalSmartValue;
...
alaqilBoost::shared_ptr< Pair<int, double> > pair_id1(alaqilBoost::shared_ptr< Pair<int, double> > p) { return p; }
%}
...
namespace alaqilBoost {
  ...
  #ifdef SHARED_PTR_WRAPPER
    return alaqilBoost::SharedPtrWrapper::getTotalCount();
  #else
    return NOT_COUNTING;
  #endif
  }
