...
%warnfilter(alaqilWARN_RUBY_WRONG_NAME) std::my_pair<int, int>;       /* Ruby, wrong class name */
%warnfilter(alaqilWARN_RUBY_WRONG_NAME) std::my_pair<double, double>; /* Ruby, wrong class name */
