...
//      if (enum_thorough.treesTestN(pine) != pine) throw new RuntimeException("treesTest Global N failed");
    ...
    {
      if (enum_thorough.ignoreATest(IgnoreTest.IgnoreA.ignoreA_zero).alaqilValue() != 0) throw new RuntimeException("ignoreATest 0 failed");
      if (enum_thorough.ignoreATest(IgnoreTest.IgnoreA.ignoreA_three).alaqilValue() != 3) throw new RuntimeException("ignoreATest 3 failed");
      if (enum_thorough.ignoreATest(IgnoreTest.IgnoreA.ignoreA_ten).alaqilValue() != 10) throw new RuntimeException("ignoreATest 10 failed");
      if (enum_thorough.ignoreATest(IgnoreTest.IgnoreA.ignoreA_eleven).alaqilValue() != 11) throw new RuntimeException("ignoreATest 11 failed");
      if (enum_thorough.ignoreATest(IgnoreTest.IgnoreA.ignoreA_thirteen).alaqilValue() != 13) throw new RuntimeException("ignoreATest 13 failed");
      if (enum_thorough.ignoreATest(IgnoreTest.IgnoreA.ignoreA_fourteen).alaqilValue() != 14) throw new RuntimeException("ignoreATest 14 failed");
      if (enum_thorough.ignoreATest(IgnoreTest.IgnoreA.ignoreA_twenty).alaqilValue() != 20) throw new RuntimeException("ignoreATest 20 failed");
      if (enum_thorough.ignoreATest(IgnoreTest.IgnoreA.ignoreA_thirty).alaqilValue() != 30) throw new RuntimeException("ignoreATest 30 failed");
      if (enum_thorough.ignoreATest(IgnoreTest.IgnoreA.ignoreA_thirty_two).alaqilValue() != 32) throw new RuntimeException("ignoreATest 32 failed");
      if (enum_thorough.ignoreATest(IgnoreTest.IgnoreA.ignoreA_thirty_three).alaqilValue() != 33) throw new RuntimeException("ignoreATest 33 failed");
    }                                                         
    {                                                         
      if (enum_thorough.ignoreBTest(IgnoreTest.IgnoreB.ignoreB_eleven).alaqilValue() != 11) throw new RuntimeException("ignoreBTest 11 failed");
      if (enum_thorough.ignoreBTest(IgnoreTest.IgnoreB.ignoreB_twelve).alaqilValue() != 12) throw new RuntimeException("ignoreBTest 12 failed");
      if (enum_thorough.ignoreBTest(IgnoreTest.IgnoreB.ignoreB_thirty_one).alaqilValue() != 31) throw new RuntimeException("ignoreBTest 31 failed");
      if (enum_thorough.ignoreBTest(IgnoreTest.IgnoreB.ignoreB_thirty_two).alaqilValue() != 32) throw new RuntimeException("ignoreBTest 32 failed");
      if (enum_thorough.ignoreBTest(IgnoreTest.IgnoreB.ignoreB_forty_one).alaqilValue() != 41) throw new RuntimeException("ignoreBTest 41 failed");
      if (enum_thorough.ignoreBTest(IgnoreTest.IgnoreB.ignoreB_forty_two).alaqilValue() != 42) throw new RuntimeException("ignoreBTest 42 failed");
    }                                                         
    {                                                         
      if (enum_thorough.ignoreCTest(IgnoreTest.IgnoreC.ignoreC_ten).alaqilValue() != 10) throw new RuntimeException("ignoreCTest 10 failed");
      if (enum_thorough.ignoreCTest(IgnoreTest.IgnoreC.ignoreC_twelve).alaqilValue() != 12) throw new RuntimeException("ignoreCTest 12 failed");
      if (enum_thorough.ignoreCTest(IgnoreTest.IgnoreC.ignoreC_thirty).alaqilValue() != 30) throw new RuntimeException("ignoreCTest 30 failed");
      if (enum_thorough.ignoreCTest(IgnoreTest.IgnoreC.ignoreC_thirty_two).alaqilValue() != 32) throw new RuntimeException("ignoreCTest 32 failed");
      if (enum_thorough.ignoreCTest(IgnoreTest.IgnoreC.ignoreC_forty).alaqilValue() != 40) throw new RuntimeException("ignoreCTest 40 failed");
      if (enum_thorough.ignoreCTest(IgnoreTest.IgnoreC.ignoreC_forty_two).alaqilValue() != 42) throw new RuntimeException("ignoreCTest 42 failed");
    }                                                         
    {                                                         
      if (enum_thorough.ignoreDTest(IgnoreTest.IgnoreD.ignoreD_twenty_one).alaqilValue() != 21) throw new RuntimeException("ignoreDTest 21 failed");
      if (enum_thorough.ignoreDTest(IgnoreTest.IgnoreD.ignoreD_twenty_two).alaqilValue() != 22) throw new RuntimeException("ignoreDTest 22 failed");
    }                                                         
    {                                                         
      if (enum_thorough.ignoreETest(IgnoreTest.IgnoreE.ignoreE_zero).alaqilValue() != 0) throw new RuntimeException("ignoreETest 0 failed");
      if (enum_thorough.ignoreETest(IgnoreTest.IgnoreE.ignoreE_twenty_one).alaqilValue() != 21) throw new RuntimeException("ignoreETest 21 failed");
      if (enum_thorough.ignoreETest(IgnoreTest.IgnoreE.ignoreE_twenty_two).alaqilValue() != 22) throw new RuntimeException("ignoreETest 22 failed");
    }
    // ignore enum item tests end
    {
      if (enum_thorough.repeatTest(repeat.one).alaqilValue() != 1) throw new RuntimeException("repeatTest 1 failed");
      if (enum_thorough.repeatTest(repeat.initial).alaqilValue() != 1) throw new RuntimeException("repeatTest 2 failed");
      if (enum_thorough.repeatTest(repeat.two).alaqilValue() != 2) throw new RuntimeException("repeatTest 3 failed");
      if (enum_thorough.repeatTest(repeat.three).alaqilValue() != 3) throw new RuntimeException("repeatTest 4 failed");
      if (enum_thorough.repeatTest(repeat.llast).alaqilValue() != 3) throw new RuntimeException("repeatTest 5 failed");
      if (enum_thorough.repeatTest(repeat.end).alaqilValue() != 3) throw new RuntimeException("repeatTest 6 failed");
    }
    // different types
    {
      if (enum_thorough.differentTypesTest(DifferentTypes.typeint).alaqilValue() != 10) throw new RuntimeException("differentTypes 1 failed");
      if (enum_thorough.differentTypesTest(DifferentTypes.typeboolfalse).alaqilValue() != 0) throw new RuntimeException("differentTypes 2 failed");
      if (enum_thorough.differentTypesTest(DifferentTypes.typebooltrue).alaqilValue() != 1) throw new RuntimeException("differentTypes 3 failed");
      if (enum_thorough.differentTypesTest(DifferentTypes.typebooltwo).alaqilValue() != 2) throw new RuntimeException("differentTypes 4 failed");
      if (enum_thorough.differentTypesTest(DifferentTypes.typechar).alaqilValue() != 'C') throw new RuntimeException("differentTypes 5 failed");
      if (enum_thorough.differentTypesTest(DifferentTypes.typedefaultint).alaqilValue() != 'D') throw new RuntimeException("differentTypes 6 failed");
